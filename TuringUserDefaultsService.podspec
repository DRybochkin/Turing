#
# Be sure to run `pod lib lint TuringUserDefaultsService.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'TuringUserDefaultsService'
  s.version          = '0.1.1'
  s.summary          = 'A short description of TuringUserDefaultsService.'
