...
public protocol TuringDIRegisterProtocol {
    ...
    typealias FabricThreeParameters<T, P1, P2, P3> = (TuringDIResolveProtocol, P1, P2, P3) -> T?
    typealias FabricTwoParameters<T, P1, P2> = (TuringDIResolveProtocol, P1, P2) -> T?
    typealias FabricOneParameter<T, P1> = (TuringDIResolveProtocol, P1) -> T?
    typealias FabricZero<T> = (TuringDIResolveProtocol) -> T?
    typealias Fabric<T> = () -> T?
    typealias FabricCompletion<T> = (TuringDIResolveProtocol, T?) -> Void
