...
public protocol TuringDIRegisterProtocol {
    ...
    typealias FabricThreeParameters<T, P1, P2, P3> = (TuringDIProtocol, P1, P2, P3) -> T?
    typealias FabricTwoParameters<T, P1, P2> = (TuringDIProtocol, P1, P2) -> T?
    typealias FabricOneParameter<T, P1> = (TuringDIProtocol, P1) -> T?
    typealias FabricZero<T> = (TuringDIProtocol) -> T?
    typealias Fabric<T> = () -> T?
    typealias FabricCompletion<T> = (TuringDIProtocol, T?) -> Void
